...
float __h=189.93852; //min:0 max:360
float __s =77.67234; //min:0 max:100
float __b =61.753456; //min:0 max:100
float __op =58.29985; //min:0 max:100

int __num_circles=6; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=24; //min:10 max:30

float __pos=0.17986156; //min:0.1 max:0.4
float __size=175.9149; //min:20 max:200
