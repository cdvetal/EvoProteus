...
float __h=214.45111; //min:0 max:360
float __s =72.31781; //min:0 max:100
float __b =59.15864; //min:0 max:100
float __op =63.535137; //min:0 max:100

int __num_circles=1; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=16; //min:10 max:30

float __pos=0.3316375; //min:0.1 max:0.4
float __size=33.158043; //min:20 max:200
