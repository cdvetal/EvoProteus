...
float __s =33.848793; //min:0 max:100
float __b =46.036713; //min:0 max:100
float __op =12.648755; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=22; //min:10 max:30

float __pos=0.24585673; //min:0.1 max:0.4
float __size=65.3691; //min:20 max:200
