...
float __h=295.01913; //min:0 max:360
float __s =75.0098; //min:0 max:100
float __b =35.37409; //min:0 max:100
float __op =99.57114; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=9; //min:2 max:10
int __num_max=25; //min:10 max:30

float __pos=0.25137562; //min:0.1 max:0.4
float __size=158.50307; //min:20 max:200
