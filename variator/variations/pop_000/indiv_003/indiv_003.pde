...
float __h=341.21432; //min:0 max:360
float __s =17.1755; //min:0 max:100
float __b =79.60776; //min:0 max:100
float __op =27.62754; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=4; //min:2 max:10
int __num_max=13; //min:10 max:30

float __pos=0.11586321; //min:0.1 max:0.4
float __size=80.99063; //min:20 max:200
