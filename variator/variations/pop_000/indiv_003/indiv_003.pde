...
float __h=137.20059; //min:0 max:360
float __s =20.205873; //min:0 max:100
float __b =83.630165; //min:0 max:100
float __op =96.52556; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=29; //min:10 max:30

float __pos=0.35875538; //min:0.1 max:0.4
float __size=150.67207; //min:20 max:200
