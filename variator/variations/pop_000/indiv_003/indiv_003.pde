...
float __h=32.461426; //min:0 max:360
float __s =57.36273; //min:0 max:100
float __b =19.829666; //min:0 max:100
float __op =11.948723; //min:0 max:100

int __num_circles=6; //min:1 max:6
int __num_min=5; //min:2 max:10
int __num_max=13; //min:10 max:30

float __pos=0.38595027; //min:0.1 max:0.4
float __size=147.74869; //min:20 max:200

void setup() {
surface.setLocation(23,292); //variator
...
v_m = new Client(this, "localhost", 3000 + 3); //variator
  size(300, 200);
