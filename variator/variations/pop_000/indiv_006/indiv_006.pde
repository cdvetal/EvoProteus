...
float __h=159.86934; //min:0 max:360
float __s =97.94045; //min:0 max:100
float __b =26.156252; //min:0 max:100
float __op =65.11252; //min:0 max:100

int __num_circles=5; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=30; //min:10 max:30

float __pos=0.3234613; //min:0.1 max:0.4
float __size=131.1416; //min:20 max:200

void setup() {
surface.setLocation(23,538); //variator
...
v_m = new Client(this, "localhost", 3000 + 6); //variator
  size(300, 200);
