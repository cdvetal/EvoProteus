...
float __h=58.54554; //min:0 max:360
float __s =39.64438; //min:0 max:100
float __b =69.929405; //min:0 max:100
float __op =66.833565; //min:0 max:100

int __num_circles=1; //min:1 max:6
int __num_min=5; //min:2 max:10
int __num_max=16; //min:10 max:30

float __pos=0.29587343; //min:0.1 max:0.4
float __size=155.31873; //min:20 max:200
