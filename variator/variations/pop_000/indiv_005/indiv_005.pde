...
float __h=160.838; //min:0 max:360
float __s =85.30081; //min:0 max:100
float __b =63.327618; //min:0 max:100
float __op =90.81301; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=5; //min:2 max:10
int __num_max=29; //min:10 max:30

float __pos=0.31618834; //min:0.1 max:0.4
float __size=21.16187; //min:20 max:200

void setup() {
surface.setLocation(669,292); //variator
...
v_m = new Client(this, "localhost", 3000 + 5); //variator
  size(300, 200);
