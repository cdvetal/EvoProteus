...
float __h=88.000275; //min:0 max:360
float __s =8.002144; //min:0 max:100
float __b =59.83912; //min:0 max:100
float __op =13.709366; //min:0 max:100

int __num_circles=5; //min:1 max:6
int __num_min=4; //min:2 max:10
int __num_max=30; //min:10 max:30

float __pos=0.34407675; //min:0.1 max:0.4
float __size=150.35312; //min:20 max:200
