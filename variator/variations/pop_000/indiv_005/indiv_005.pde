...
int __c1 =99; // min:0 max:255
int __c2 =236; // min:0 max:255
int __c3 =136; //min:0 max:255
...
float __spring = 0.05;
float __gravity =0.029176665; // min:0.01 max:0.05
float __friction = -0.9;
Ball[] balls = new Ball[__numBalls];

void setup() {
surface.setLocation(949,252);PSurfaceAWT awtSurface = (PSurfaceAWT)surface;smoothCanvas = (PSurfaceAWT.SmoothCanvas)awtSurface.getNative();println("[Client] Client connected");v_m = new Client(this, "localhost", 3000 + 5);//variator
