...
float __h=40.695335; //min:0 max:360
float __s =28.381628; //min:0 max:100
float __b =48.492825; //min:0 max:100
float __op =85.88855; //min:0 max:100

int __num_circles=1; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=16; //min:10 max:30

float __pos=0.37441266; //min:0.1 max:0.4
float __size=162.94104; //min:20 max:200

void setup() {
surface.setLocation(346,538); //variator
...
v_m = new Client(this, "localhost", 3000 + 7); //variator
  size(300, 200);
