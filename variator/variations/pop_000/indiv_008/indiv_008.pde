...
float __h=220.8624; //min:0 max:360
float __s =31.840467; //min:0 max:100
float __b =5.8103857; //min:0 max:100
float __op =3.3170223; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=9; //min:2 max:10
int __num_max=29; //min:10 max:30

float __pos=0.34671873; //min:0.1 max:0.4
float __size=73.924576; //min:20 max:200
