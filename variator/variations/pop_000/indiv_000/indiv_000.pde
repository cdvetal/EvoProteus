...
float __h=55.240204; //min:0 max:360
float __s =9.78294; //min:0 max:100
float __b =49.49324; //min:0 max:100
float __op =63.226162; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=18; //min:10 max:30

float __pos=0.21079753; //min:0.1 max:0.4
float __size=107.94006; //min:20 max:200
