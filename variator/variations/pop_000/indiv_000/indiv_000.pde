...
float __h=304.52942; //min:0 max:360
float __s =4.6097097; //min:0 max:100
float __b =68.839226; //min:0 max:100
float __op =71.65217; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=21; //min:10 max:30

float __pos=0.1174484; //min:0.1 max:0.4
float __size=39.294243; //min:20 max:200

void setup() {
surface.setLocation(23,46); //variator
...
v_m = new Client(this, "localhost", 3000 + 0); //variator
  size(300, 200);
