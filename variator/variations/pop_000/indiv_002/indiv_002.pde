...
int __c1 =70; // min:0 max:255
int __c2 =154; // min:0 max:255
int __c3 =97; //min:0 max:255

boolean __teste =false; //min:true max:false



int __numBalls =4; // min:0 max:25
int __diameter =61; // min:10 max:80
float __spring = 0.05;
float __gravity =0.047563553; // min:0.01 max:0.05
