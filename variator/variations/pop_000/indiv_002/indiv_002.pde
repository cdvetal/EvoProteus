...
float __h=96.27678; //min:0 max:360
float __s =12.558192; //min:0 max:100
float __b =64.24513; //min:0 max:100
float __op =64.925476; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=9; //min:2 max:10
int __num_max=17; //min:10 max:30

float __pos=0.16321287; //min:0.1 max:0.4
float __size=23.200691; //min:20 max:200

void setup() {
surface.setLocation(669,46); //variator
...
v_m = new Client(this, "localhost", 3000 + 2); //variator
  size(300, 200);
