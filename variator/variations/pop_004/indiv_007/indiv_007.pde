...
float __s =25.342049; //min:0 max:100
float __b =97.93695; //min:0 max:100
float __op =87.7849; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=20; //min:10 max:30

float __pos=0.31152415; //min:0.1 max:0.4
float __size=115.431885; //min:20 max:200
