...
float __h=324.38535; //min:0 max:360
float __s =39.458977; //min:0 max:100
float __b =83.634865; //min:0 max:100
float __op =51.236244; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=18; //min:10 max:30

float __pos=0.10229842; //min:0.1 max:0.4
