...
float __h=136.45679; //min:0 max:360
float __s =11.397192; //min:0 max:100
float __b =5.594021; //min:0 max:100
float __op =40.178005; //min:0 max:100
...
float __size=83.582; //min:20 max:200
