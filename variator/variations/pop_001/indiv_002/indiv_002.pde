...
float __h=280.4412; //min:0 max:360
float __s =56.98609; //min:0 max:100
float __b =91.420815; //min:0 max:100
...
float __pos=0.12317607; //min:0.1 max:0.4
float __size=66.84504; //min:20 max:200
