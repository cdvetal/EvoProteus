...
float __h=106.536674; //min:0 max:360
float __s =12.304979; //min:0 max:100
float __b =56.65159; //min:0 max:100
float __op =65.20745; //min:0 max:100
...
float __size=26.41906; //min:20 max:200
