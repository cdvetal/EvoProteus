...
float __h=185.08319; //min:0 max:360
float __s =32.630775; //min:0 max:100
float __b =91.66309; //min:0 max:100
float __op =93.7443; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=21; //min:10 max:30

float __pos=0.28427; //min:0.1 max:0.4
