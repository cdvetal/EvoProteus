...
float __s =92.85335; //min:0 max:100
float __b =31.45405; //min:0 max:100
float __op =84.98309; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=4; //min:2 max:10
int __num_max=18; //min:10 max:30

float __pos=0.32056668; //min:0.1 max:0.4
float __size=100.54455; //min:20 max:200
