...
float __h=303.84753; //min:0 max:360
float __s =87.652824; //min:0 max:100
float __b =93.6593; //min:0 max:100
float __op =91.38875; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=18; //min:10 max:30

float __pos=0.2916081; //min:0.1 max:0.4
