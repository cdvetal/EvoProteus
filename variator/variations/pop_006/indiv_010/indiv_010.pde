...
float __h=228.368; //min:0 max:360
float __s =34.281807; //min:0 max:100
float __b =24.894867; //min:0 max:100
float __op =83.45527; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=4; //min:2 max:10
int __num_max=18; //min:10 max:30

float __pos=0.302061; //min:0.1 max:0.4
float __size=121.93476; //min:20 max:200
