...
float __h=225.60301; //min:0 max:360
float __s =46.02734; //min:0 max:100
float __b =27.512165; //min:0 max:100
float __op =86.42155; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=18; //min:10 max:30

float __pos=0.28922886; //min:0.1 max:0.4
float __size=120.81515; //min:20 max:200
