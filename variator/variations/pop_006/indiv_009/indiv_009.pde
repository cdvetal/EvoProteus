...
float __s =89.1263; //min:0 max:100
float __b =85.03854; //min:0 max:100
float __op =87.9635; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=17; //min:10 max:30

float __pos=0.2800405; //min:0.1 max:0.4
float __size=117.735954; //min:20 max:200
