...
float __h=201.89793; //min:0 max:360
float __s =41.108208; //min:0 max:100
float __b =27.542015; //min:0 max:100
float __op =92.536736; //min:0 max:100
...
void setup() {
surface.setLocation(23,784);PSurfaceAWT awtSurface = (PSurfaceAWT)surface;smoothCanvas = (PSurfaceAWT.SmoothCanvas)awtSurface.getNative();println("[Client] Client connected");v_m = new Client(this, "localhost", 3000 + 9);//variator
  size(300, 200);
