...
float __h=277.39337; //min:0 max:360
float __s =98.66321; //min:0 max:100
float __b =95.67525; //min:0 max:100
float __op =88.75633; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=20; //min:10 max:30

float __pos=0.30792552; //min:0.1 max:0.4
float __size=114.84589; //min:20 max:200
