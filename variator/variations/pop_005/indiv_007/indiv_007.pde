...
float __h=248.94984; //min:0 max:360
float __s =46.193436; //min:0 max:100
float __b =31.511719; //min:0 max:100
float __op =85.54948; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=19; //min:10 max:30

float __pos=0.32727602; //min:0.1 max:0.4
float __size=128.04517; //min:20 max:200
