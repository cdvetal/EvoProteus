...
float __h=329.77304; //min:0 max:360
float __s =99.537895; //min:0 max:100
float __b =82.10841; //min:0 max:100
float __op =55.58546; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=17; //min:10 max:30

float __pos=0.10896003; //min:0.1 max:0.4
float __size=52.864975; //min:20 max:200
