...
float __h=272.66583; //min:0 max:360
float __s =79.58992; //min:0 max:100
float __b =94.68628; //min:0 max:100
float __op =93.866905; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=20; //min:10 max:30

float __pos=0.3380089; //min:0.1 max:0.4
float __size=90.50945; //min:20 max:200
