...
float __h=351.9153; //min:0 max:360
float __s =30.59581; //min:0 max:100
float __b =43.536842; //min:0 max:100
float __op =26.785063; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=5; //min:2 max:10
int __num_max=24; //min:10 max:30

float __pos=0.21283379; //min:0.1 max:0.4
float __size=116.76066; //min:20 max:200
