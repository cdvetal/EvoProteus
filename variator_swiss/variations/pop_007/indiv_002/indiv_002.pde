...
float __h=59.8163; //min:0 max:360
float __s =79.706696; //min:0 max:100
float __b =33.619473; //min:0 max:100
float __op =33.760963; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=5; //min:2 max:10
int __num_max=24; //min:10 max:30

float __pos=0.33100665; //min:0.1 max:0.4
float __size=94.93965; //min:20 max:200
