...
float __h=56.920303; //min:0 max:360
float __s =99.25189; //min:0 max:100
float __b =99.75263; //min:0 max:100
float __op =11.684174; //min:0 max:100
...
float __size=122.06359; //min:20 max:200
