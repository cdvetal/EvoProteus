...
float __h=317.6838; //min:0 max:360
float __s =100.0; //min:0 max:100
float __b =59.260487; //min:0 max:100
...
float __pos=0.24473248; //min:0.1 max:0.4
float __size=107.678154; //min:20 max:200
