...
float __h=180.5755; //min:0 max:360
float __s =50.070984; //min:0 max:100
float __b =90.28252; //min:0 max:100
float __op =69.38968; //min:0 max:100

int __num_circles=5; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=14; //min:10 max:30

float __pos=0.19655064; //min:0.1 max:0.4
float __size=57.373653; //min:20 max:200
