...
float __h=145.48532; //min:0 max:360
float __s =41.70583; //min:0 max:100
float __b =34.350216; //min:0 max:100
float __op =76.22659; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=24; //min:10 max:30

float __pos=0.24096425; //min:0.1 max:0.4
float __size=108.24149; //min:20 max:200
