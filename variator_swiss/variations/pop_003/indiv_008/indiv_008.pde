...
float __h=2.8289; //min:0 max:360
float __s =88.31765; //min:0 max:100
float __b =52.991947; //min:0 max:100
...
float __pos=0.28244996; //min:0.1 max:0.4
float __size=72.23863; //min:20 max:200
