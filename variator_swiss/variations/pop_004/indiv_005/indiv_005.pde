...
float __h=231.06035; //min:0 max:360
float __s =66.693306; //min:0 max:100
float __b =18.605274; //min:0 max:100
float __op =24.341667; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=26; //min:10 max:30

float __pos=0.22132497; //min:0.1 max:0.4
float __size=184.18094; //min:20 max:200
