...
float __h=208.26091; //min:0 max:360
float __s =27.294506; //min:0 max:100
float __b =78.87344; //min:0 max:100
float __op =45.667957; //min:0 max:100

int __num_circles=1; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=23; //min:10 max:30

float __pos=0.398426; //min:0.1 max:0.4
float __size=125.275826; //min:20 max:200
