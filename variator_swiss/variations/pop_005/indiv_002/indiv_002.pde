...
float __h=137.31451; //min:0 max:360
float __s =49.013203; //min:0 max:100
float __b =0.0; //min:0 max:100
float __op =32.90778; //min:0 max:100
...
float __size=89.10275; //min:20 max:200
