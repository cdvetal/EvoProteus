...
float __h=56.629406; //min:0 max:360
float __s =80.17791; //min:0 max:100
float __b =33.487762; //min:0 max:100
...
float __pos=0.19216278; //min:0.1 max:0.4
float __size=118.06029; //min:20 max:200
