...
float __h=82.466576; //min:0 max:360
float __s =85.033905; //min:0 max:100
float __b =99.775696; //min:0 max:100
float __op =56.32105; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=24; //min:10 max:30

float __pos=0.29177073; //min:0.1 max:0.4
float __size=176.32199; //min:20 max:200
