...
float __h=153.61005; //min:0 max:360
float __s =14.596576; //min:0 max:100
float __b =83.683464; //min:0 max:100
float __op =17.161959; //min:0 max:100

int __num_circles=6; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=14; //min:10 max:30

float __pos=0.36828253; //min:0.1 max:0.4
float __size=67.61003; //min:20 max:200
