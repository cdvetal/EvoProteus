...
float __h=69.99982; //min:0 max:360
float __s =78.276245; //min:0 max:100
float __b =86.07735; //min:0 max:100
float __op =7.088834; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=10; //min:2 max:10
int __num_max=20; //min:10 max:30

float __pos=0.20282495; //min:0.1 max:0.4
float __size=151.97925; //min:20 max:200
