...
float __h=159.6304; //min:0 max:360
float __s =2.4080038; //min:0 max:100
float __b =89.354065; //min:0 max:100
float __op =91.63008; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=16; //min:10 max:30

float __pos=0.15225197; //min:0.1 max:0.4
float __size=182.05249; //min:20 max:200
