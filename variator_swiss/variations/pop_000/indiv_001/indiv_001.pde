...
float __h=290.0601; //min:0 max:360
float __s =57.588673; //min:0 max:100
float __b =61.85186; //min:0 max:100
float __op =97.59081; //min:0 max:100

int __num_circles=5; //min:1 max:6
int __num_min=9; //min:2 max:10
int __num_max=13; //min:10 max:30

float __pos=0.14546639; //min:0.1 max:0.4
float __size=94.77757; //min:20 max:200
