...
float __h=333.3052; //min:0 max:360
float __s =22.65883; //min:0 max:100
float __b =99.442795; //min:0 max:100
float __op =4.476184; //min:0 max:100

int __num_circles=1; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=19; //min:10 max:30

float __pos=0.3842454; //min:0.1 max:0.4
float __size=92.84177; //min:20 max:200
