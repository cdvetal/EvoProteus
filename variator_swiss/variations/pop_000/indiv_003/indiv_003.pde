...
float __h=115.65473; //min:0 max:360
float __s =57.06082; //min:0 max:100
float __b =54.8472; //min:0 max:100
float __op =39.664913; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=27; //min:10 max:30

float __pos=0.38581046; //min:0.1 max:0.4
float __size=84.12163; //min:20 max:200
