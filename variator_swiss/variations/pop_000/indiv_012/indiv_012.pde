...
float __h=110.784805; //min:0 max:360
float __s =27.716583; //min:0 max:100
float __b =58.965786; //min:0 max:100
float __op =76.70617; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=10; //min:2 max:10
int __num_max=25; //min:10 max:30

float __pos=0.27724007; //min:0.1 max:0.4
float __size=163.8146; //min:20 max:200
