...
float __h=3.452046; //min:0 max:360
float __s =56.04716; //min:0 max:100
float __b =20.710976; //min:0 max:100
float __op =49.92753; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=21; //min:10 max:30

float __pos=0.115082204; //min:0.1 max:0.4
float __size=157.62506; //min:20 max:200
