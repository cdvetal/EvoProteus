...
float __h=51.170967; //min:0 max:360
float __s =43.152596; //min:0 max:100
float __b =71.41649; //min:0 max:100
float __op =43.883778; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=22; //min:10 max:30

float __pos=0.29375526; //min:0.1 max:0.4
float __size=182.70735; //min:20 max:200
