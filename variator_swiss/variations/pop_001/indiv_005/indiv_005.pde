...
float __h=114.42621; //min:0 max:360
float __s =40.675568; //min:0 max:100
float __b =100.0; //min:0 max:100
float __op =42.964954; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=20; //min:10 max:30

float __pos=0.27036998; //min:0.1 max:0.4
float __size=30.110779; //min:20 max:200
