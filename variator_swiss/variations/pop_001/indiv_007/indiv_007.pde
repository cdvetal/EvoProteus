...
float __h=31.083841; //min:0 max:360
float __s =88.6255; //min:0 max:100
float __b =88.251; //min:0 max:100
float __op =85.02101; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=4; //min:2 max:10
int __num_max=15; //min:10 max:30

float __pos=0.39583844; //min:0.1 max:0.4
float __size=41.768967; //min:20 max:200
