float __x =82.95424; //min:0 max:200
float __y =186.53195; //min:0 max:200
float __width =130.27606; //min:70 max:200
float __height =152.74713; //min:70 max:200

float __r =128.23405; //min:1 max:255
float __g =74.52611; //min:1 max:255
float __b =136.35893; //min:1 max:255
