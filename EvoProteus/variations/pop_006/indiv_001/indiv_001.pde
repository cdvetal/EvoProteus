float __x =72.67259; //min:0 max:200
float __y =164.83957; //min:0 max:200
float __width =145.39487; //min:70 max:200
float __height =152.74713; //min:70 max:200

float __r =119.452484; //min:1 max:255
float __g =22.592182; //min:1 max:255
float __b =29.21164; //min:1 max:255
