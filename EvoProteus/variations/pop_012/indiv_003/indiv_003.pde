...
float __y =180.88898; //min:0 max:200
float __width =137.18552; //min:70 max:200
float __height =136.83246; //min:70 max:200

float __r =148.1982; //min:1 max:255
