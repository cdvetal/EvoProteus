float __x =115.37323; //min:0 max:200
float __y =200.0; //min:0 max:200
float __width =116.43049; //min:70 max:200
float __height =152.74713; //min:70 max:200

float __r =132.64748; //min:1 max:255
float __g =52.614693; //min:1 max:255
float __b =60.72913; //min:1 max:255
