...
float __h=137.3131; //min:0 max:360
float __s =6.5181074; //min:0 max:100
float __b =0.5915046; //min:0 max:100
float __op =23.961079; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=18; //min:10 max:30

float __pos=0.32241067; //min:0.1 max:0.4
float __size=23.75519; //min:20 max:200

void setup() {
surface.setLocation(346,46); //INJECTED LINE
...
v_m = new Client(this, "localhost", 3000 + 1); //INJECTED LINE
  size(300, 200);
