...
float __h=90.13366; //min:0 max:360
float __s =95.30581; //min:0 max:100
float __b =54.762955; //min:0 max:100
float __op =48.93072; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=4; //min:2 max:10
int __num_max=21; //min:10 max:30

float __pos=0.105823755; //min:0.1 max:0.4
float __size=76.34952; //min:20 max:200

void setup() {
surface.setLocation(23,292); //INJECTED LINE
...
v_m = new Client(this, "localhost", 3000 + 3); //INJECTED LINE
  size(300, 200);
