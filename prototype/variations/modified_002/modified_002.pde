...
float __h=238.27681; //min:0 max:360
float __s =70.451515; //min:0 max:100
float __b =75.26259; //min:0 max:100
float __op =6.7937613; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=8; //min:2 max:10
int __num_max=21; //min:10 max:30

float __pos=0.31911588; //min:0.1 max:0.4
float __size=114.046005; //min:20 max:200

void setup() {
surface.setLocation(669,46); //INJECTED LINE
...
v_m = new Client(this, "localhost", 3000 + 2); //INJECTED LINE
  size(300, 200);
