...
float __h=177.97835; //min:0 max:360
float __s =16.170383; //min:0 max:100
float __b =17.62156; //min:0 max:100
float __op =64.02448; //min:0 max:100

int __num_circles=1; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=27; //min:10 max:30

float __pos=0.25388107; //min:0.1 max:0.4
float __size=130.49011; //min:20 max:200

void setup() {
surface.setLocation(346,292); //INJECTED LINE
...
v_m = new Client(this, "localhost", 3000 + 4); //INJECTED LINE
  size(300, 200);
