...
float __h=187.4159; //min:0 max:360
float __s =69.247406; //min:0 max:100
float __b =66.084595; //min:0 max:100
float __op =68.716446; //min:0 max:100
...
float __size=35.2212; //min:20 max:200
