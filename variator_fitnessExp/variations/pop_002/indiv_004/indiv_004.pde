...
float __h=10.433672; //min:0 max:360
float __s =2.374673; //min:0 max:100
float __b =1.5255053; //min:0 max:100
float __op =27.540398; //min:0 max:100

int __num_circles=5; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=17; //min:10 max:30

float __pos=0.27888778; //min:0.1 max:0.4
float __size=83.64512; //min:20 max:200
