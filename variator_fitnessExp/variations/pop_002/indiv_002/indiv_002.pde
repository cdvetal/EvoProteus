...
float __h=47.53898; //min:0 max:360
float __s =15.980814; //min:0 max:100
float __b =3.7236512; //min:0 max:100
...
float __pos=0.3485828; //min:0.1 max:0.4
float __size=34.17245; //min:20 max:200
