...
float __h=252.33096; //min:0 max:360
float __s =19.734438; //min:0 max:100
float __b =92.8191; //min:0 max:100
float __op =47.980804; //min:0 max:100

int __num_circles=5; //min:1 max:6
int __num_min=7; //min:2 max:10
int __num_max=15; //min:10 max:30

float __pos=0.10210696; //min:0.1 max:0.4
float __size=72.94169; //min:20 max:200
