...
float __h=315.8509; //min:0 max:360
float __s =24.11021; //min:0 max:100
float __b =92.53298; //min:0 max:100
float __op =46.396362; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=7; //min:2 max:10
int __num_max=26; //min:10 max:30

float __pos=0.19000655; //min:0.1 max:0.4
float __size=76.46727; //min:20 max:200
