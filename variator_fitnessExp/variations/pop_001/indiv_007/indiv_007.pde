...
float __h=194.69383; //min:0 max:360
float __s =23.606005; //min:0 max:100
float __b =41.646797; //min:0 max:100
float __op =24.193419; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=5; //min:2 max:10
int __num_max=25; //min:10 max:30

float __pos=0.16980457; //min:0.1 max:0.4
float __size=30.1338; //min:20 max:200
