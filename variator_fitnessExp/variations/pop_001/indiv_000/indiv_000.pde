...
float __s =69.61434; //min:0 max:100
float __b =53.313812; //min:0 max:100
float __op =0.0; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=17; //min:10 max:30

float __pos=0.3114586; //min:0.1 max:0.4
float __size=182.45528; //min:20 max:200
