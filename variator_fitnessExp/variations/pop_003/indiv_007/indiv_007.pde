...
float __h=22.931862; //min:0 max:360
float __s =26.58106; //min:0 max:100
float __b =2.554605; //min:0 max:100
float __op =28.924871; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=22; //min:10 max:30

float __pos=0.3452334; //min:0.1 max:0.4
float __size=55.180244; //min:20 max:200
