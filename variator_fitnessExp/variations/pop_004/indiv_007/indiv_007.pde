...
float __h=172.3435; //min:0 max:360
float __s =31.72021; //min:0 max:100
float __b =71.368454; //min:0 max:100
float __op =59.27189; //min:0 max:100

int __num_circles=1; //min:1 max:6
int __num_min=2; //min:2 max:10
int __num_max=19; //min:10 max:30

float __pos=0.29932427; //min:0.1 max:0.4
