...
float __h=294.08557; //min:0 max:360
float __s =94.699356; //min:0 max:100
float __b =77.02542; //min:0 max:100
float __op =58.856255; //min:0 max:100

int __num_circles=5; //min:1 max:6
int __num_min=4; //min:2 max:10
int __num_max=17; //min:10 max:30

float __pos=0.31472492; //min:0.1 max:0.4
float __size=168.52364; //min:20 max:200
