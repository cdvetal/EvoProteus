...
float __h=182.76921; //min:0 max:360
float __s =22.526672; //min:0 max:100
float __b =78.44812; //min:0 max:100
float __op =44.739044; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=4; //min:2 max:10
int __num_max=23; //min:10 max:30

float __pos=0.39756796; //min:0.1 max:0.4
float __size=111.22684; //min:20 max:200
