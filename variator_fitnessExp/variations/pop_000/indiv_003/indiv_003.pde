...
float __h=74.26314; //min:0 max:360
float __s =22.622406; //min:0 max:100
float __b =13.107157; //min:0 max:100
float __op =84.59128; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=10; //min:2 max:10
int __num_max=12; //min:10 max:30

float __pos=0.30923614; //min:0.1 max:0.4
float __size=148.55008; //min:20 max:200
