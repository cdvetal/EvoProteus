...
float __h=217.758; //min:0 max:360
float __s =24.547005; //min:0 max:100
float __b =38.62774; //min:0 max:100
...
float __pos=0.18219298; //min:0.1 max:0.4
float __size=35.005028; //min:20 max:200
