...
float __h=181.45929; //min:0 max:360
float __s =39.19188; //min:0 max:100
float __b =61.58358; //min:0 max:100
float __op =42.51138; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=26; //min:10 max:30

float __pos=0.1221047; //min:0.1 max:0.4
float __size=43.929565; //min:20 max:200
