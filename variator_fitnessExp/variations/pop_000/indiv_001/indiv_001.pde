...
float __h=83.3793; //min:0 max:360
float __s =69.01783; //min:0 max:100
float __b =16.818762; //min:0 max:100
float __op =97.143814; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=18; //min:10 max:30

float __pos=0.18585004; //min:0.1 max:0.4
float __size=136.44344; //min:20 max:200
