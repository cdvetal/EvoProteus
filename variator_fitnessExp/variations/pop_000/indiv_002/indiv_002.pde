...
float __h=133.62186; //min:0 max:360
float __s =55.789536; //min:0 max:100
float __b =78.48376; //min:0 max:100
float __op =47.355644; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=16; //min:10 max:30

float __pos=0.17067346; //min:0.1 max:0.4
float __size=151.69324; //min:20 max:200
