...
float __h=44.257973; //min:0 max:360
float __s =78.31549; //min:0 max:100
float __b =79.271675; //min:0 max:100
float __op =24.370773; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=7; //min:2 max:10
int __num_max=24; //min:10 max:30

float __pos=0.3218388; //min:0.1 max:0.4
float __size=94.24961; //min:20 max:200
