...
class Evaluator implements Runnable {
  ...
  public void run() {
    ...
    String pathScript = "C:/Users/cdv/Desktop/ricardosacadura_research/version_2_0/EvoProteus/MetricAPI/bridge_script.py";
    ...
    try {
      ...
      JSONObject jsonData = JSONObject.parse(output);
