...
float __h=12.665928; //min:0 max:360
float __s =10.90396; //min:0 max:100
float __b =25.43558; //min:0 max:100
float __op =46.568077; //min:0 max:100

int __num_circles=5; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=16; //min:10 max:30

float __pos=0.17650804; //min:0.1 max:0.4
float __size=63.268494; //min:20 max:200
