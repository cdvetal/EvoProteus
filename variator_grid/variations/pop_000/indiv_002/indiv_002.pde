...
float __h=68.50422; //min:0 max:360
float __s =66.992355; //min:0 max:100
float __b =50.505817; //min:0 max:100
float __op =82.51336; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=3; //min:2 max:10
int __num_max=12; //min:10 max:30

float __pos=0.35361445; //min:0.1 max:0.4
float __size=181.30537; //min:20 max:200
