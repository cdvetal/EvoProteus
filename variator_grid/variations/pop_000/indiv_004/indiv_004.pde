...
float __h=338.00208; //min:0 max:360
float __s =75.69981; //min:0 max:100
float __b =11.446542; //min:0 max:100
float __op =82.449684; //min:0 max:100

int __num_circles=3; //min:1 max:6
int __num_min=9; //min:2 max:10
int __num_max=11; //min:10 max:30

float __pos=0.36186752; //min:0.1 max:0.4
float __size=66.036575; //min:20 max:200
