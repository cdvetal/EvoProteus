...
float __h=247.85626; //min:0 max:360
float __s =70.40529; //min:0 max:100
float __b =85.79141; //min:0 max:100
float __op =6.920475; //min:0 max:100

int __num_circles=5; //min:1 max:6
int __num_min=4; //min:2 max:10
int __num_max=10; //min:10 max:30

float __pos=0.37811548; //min:0.1 max:0.4
float __size=23.558434; //min:20 max:200
