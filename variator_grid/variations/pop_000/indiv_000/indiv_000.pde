...
float __h=109.46131; //min:0 max:360
float __s =39.86148; //min:0 max:100
float __b =25.915909; //min:0 max:100
float __op =96.33018; //min:0 max:100

int __num_circles=4; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=12; //min:10 max:30

float __pos=0.11065785; //min:0.1 max:0.4
float __size=109.15176; //min:20 max:200
