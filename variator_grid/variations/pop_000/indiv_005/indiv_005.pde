...
float __h=151.28088; //min:0 max:360
float __s =95.78956; //min:0 max:100
float __b =30.074532; //min:0 max:100
float __op =24.99997; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=15; //min:10 max:30

float __pos=0.22170116; //min:0.1 max:0.4
float __size=135.00523; //min:20 max:200
