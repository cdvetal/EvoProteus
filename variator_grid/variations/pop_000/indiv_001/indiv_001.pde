...
float __h=280.94977; //min:0 max:360
float __s =51.938843; //min:0 max:100
float __b =80.30216; //min:0 max:100
float __op =2.1755755; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=7; //min:2 max:10
int __num_max=23; //min:10 max:30

float __pos=0.14868781; //min:0.1 max:0.4
float __size=113.9982; //min:20 max:200
