...
float __h=240.67572; //min:0 max:360
float __s =55.00614; //min:0 max:100
float __b =72.349266; //min:0 max:100
float __op =59.998196; //min:0 max:100

int __num_circles=2; //min:1 max:6
int __num_min=6; //min:2 max:10
int __num_max=28; //min:10 max:30

float __pos=0.37838846; //min:0.1 max:0.4
float __size=125.79921; //min:20 max:200
