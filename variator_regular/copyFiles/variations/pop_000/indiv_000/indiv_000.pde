...
float __h =115.08593; //min:0 max:360
float __s =80.44509; //min:0 max:100
float __b =35.302258; //min:0 max:100
float __op =18.395012; //min:0 max:100

int __num_circles =4; //min:1 max:6
int __num_min =7; //min:2 max:10
int __num_max =19; //min:10 max:30

float __pos =0.27485436; //min:0.1 max:0.4
float __size =144.65297; //min:20 max:200
